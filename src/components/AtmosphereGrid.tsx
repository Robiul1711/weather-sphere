      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="glass-panel p-5 flex flex-col justify-between gap-4">
          <div className="flex items-center justify-between">
            ...
            <span className={`text-[11px] font-bold px-2.5 py-0.5 rounded-full border ${aqi.badgeClass}`}>
              {aqi.status}
            </span>
          </div>
          ...
          <div>
            <div className="text-3xl font-black font-display text-white">
              {airQuality.aqiUs} <span className="text-sm font-normal text-slate-400">US AQI</span>
            </div>
        ...
        <div className="glass-panel p-5 flex flex-col justify-between gap-4">
          ...
          <div>
            <div className="text-3xl font-black font-display text-white">{current.uvIndex}</div>
            <p className="text-xs text-slate-400 mt-1">{uv.advice}</p>
          </div>
        ...
        <div className="glass-panel p-5 flex flex-col justify-between gap-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative w-12 h-12 rounded-full border border-dashed border-white/20 flex items-center justify-center">
              <div
                className="w-1 h-8 rounded-full bg-gradient-to-t from-rose-500 to-sky-400 transition-transform duration-500"
                style={{ transform: `rotate(${current.windDirection}deg)` }}
              />
              <span className="absolute -bottom-5 text-[10px] font-bold text-slate-400">
          ...
          <div className="text-[11px] text-slate-400">
            Bearing direction: <span className="text-sky-300 font-semibold">{windDir} ({current.windDirection}°)</span>
          </div>
        </div>
        ...
        <div className="glass-panel p-5 flex flex-col justify-between gap-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="p-2.5 rounded-xl bg-white/5 border border-white/5 flex items-center gap-2.5">
              ...
              <div>
                <span className="block text-[10px] text-slate-400 uppercase font-semibold">Sunrise</span>
                <span className="block text-xs font-bold text-white">{sunrise}</span>
              </div>
            </div>
            ...
            <div className="p-2.5 rounded-xl bg-white/5 border border-white/5 flex items-center gap-2.5">
              ...
              <div>
                <span className="block text-[10px] text-slate-400 uppercase font-semibold">Sunset</span>
                <span className="block text-xs font-bold text-white">{sunset}</span>
              </div>
            </div>
          </div>

          <div className="flex items-center gap-1.5 text-xs text-slate-400 font-medium">
            <Clock4 className="w-3.5 h-3.5 text-sky-400" />
        ...
        <div className="glass-panel p-5 flex flex-col justify-between gap-3">
          ...
          <div>
            <div className="text-3xl font-black font-display text-white">
              {current.visibility} <span className="text-sm font-normal text-slate-400">km</span>
            </div>
            <p className="text-xs text-slate-400 mt-1">
              {current.visibility >= 10 ? 'Perfect atmospheric horizon view' : 'Light haze or mist present'}
            </p>
          </div>
        ...
        <div className="glass-panel p-5 flex flex-col justify-between gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">
              Relative humidity is currently <strong className="text-slate-200">{current.relativeHumidity}%</strong>
            </p>
          </div>
